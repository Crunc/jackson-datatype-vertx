...
public class JacksonBaseTest //extends TestCase
    {
     ...
     */
        ...
        protected void verifyIntToken(JsonToken t, boolean requireNumbers)
        {
            ...
            if (t != JsonToken.VALUE_STRING) {
                Assert.fail("Expected INT or STRING value, got " + t);
            }
        }
...
//        }
     ...
     */
        ...
        {
            if (ob == null) {
                Assert.fail("Expected an object of type " + expType.getName() + ", got null");
            }
            Class<?> cls = ob.getClass();
            if (!expType.isAssignableFrom(cls)) {
                Assert.fail("Expected type " + expType.getName() + ", got " + cls.getName());
            }
        }
                ...
                throws IOException, JsonParseException
        {
            ...
            if (str.length() !=  actLen) {
                Assert.fail("Internal problem (jp.token == " + jp.getCurrentToken() + "): jp.getText().length() ['" + str + "'] == " + str.length() + "; jp.getTextLength() == " + actLen);
            }
